...
public interface InterceptionsHolder {
    ...
    public open val fallbackInterceptions: MutableList<CallInterception>
    ...
    public class InterceptionsBuilder(private val holder: InterceptionsHolder) {
         ...
         * */
        public fun afterRespose(vararg phases: PipelinePhase = arrayOf(ApplicationSendPipeline.After)): Unit =
